...
return response()->json("probleme de récupération des données 1e->getMessage(),500");
}
}
...
return response()->json("probleme de modification 1e->getMessage(),500");
}
}
...
return response()->json("probleme de suppression de catégorie 1e->getMessage(),500");
}
}
...
return response()->json("Selection impossible 1e->getMessage(),500");
}
}
